...
- Replace all `Elyra` (case sensitive) with your server name.
- Replace all `elyra` (case sensitive) with your lowercase server name.
- Replace `elyrarsps.com`/`Elyrarsps.com` with your domain name.
