...
cp native/build-x64/src/Release/Elyra.exe build/win-x64/
cp build/libs/Elyra.jar build/win-x64/
...
echo Elyra.exe 64bit sha256sum
sha256sum build/win-x64/Elyra.exe

dumpbin //HEADERS build/win-x64/Elyra.exe
