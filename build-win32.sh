...
cp native/build-x86/src/Release/Elyra.exe build/win-x86/
cp build/libs/Elyra.jar build/win-x86/
...
echo Elyra.exe 32bit sha256sum
sha256sum build/win-x86/Elyra.exe

dumpbin //HEADERS build/win-x86/Elyra.exe
