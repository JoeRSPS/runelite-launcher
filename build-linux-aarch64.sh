...
chmod 644 build/libs/Elyra.jar

cp native/build-aarch64/src/Elyra build/linux-aarch64/
cp build/libs/Elyra.jar build/linux-aarch64/
...
# Symlink AppRun -> Elyra
ln -s Elyra AppRun

# Ensure Elyra is executable to all users
chmod 755 Elyra
popd
